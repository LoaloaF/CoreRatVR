...
if __name__ == "__main__":
    ...
    if os.path.exists(db_fname):
        ...
        print(f"{db_fname} created successfully.")

    # Create the test database for test-writing
    if os.path.exists(test_db_fname):
        raise ValueError(f"{test_db_fname} already exists. Cannot create a new database.")
    else:
        create_ratvr_db(test_db_fname)
        print(f"{test_db_fname} created successfully.")
