...
def _log(termflag_shm, ballvel_shm, portentaout_shm, paradigm_running_shm, full_fname):
    L = Logger()
...
def run_log_portenta(termflag_shm_struc_fname, ballvelocity_shm_struc_fname, 
                     portentaoutput_shm_struc_fname, paradigmflag_shm_struc_fname,
                     session_data_dir):
    L = Logger()
    # shm access
    ...
    while not paradigm_running_shm.is_set():
        ...
        L.logger.debug(f"Usage: {ballvel_shm.usage}")  
    ...
    _log(termflag_shm, ballvel_shm, portentaout_shm, paradigm_running_shm, full_fname)
